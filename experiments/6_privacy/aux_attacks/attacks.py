...
def create_dataset():
    ...
    while repeat:
        ...
        american_women_samples = samples[(labels == 0) * (p_targets == 0)][:50]
        indian_women_samples = samples[(labels == 0) * (p_targets == 1)][:50]
        
        american_men_samples = samples[(labels == 1) * (p_targets == 0)][:50]
        indian_men_samples = samples[(labels == 1) * (p_targets == 1)][:50]
    ...
    for p in p_indian_list:
        ...
        for idx in range(10):
            ...
            for s in range(n_models):
                ...
                results_women = results[:100, 0]
                results_men = results[100:, 1]
