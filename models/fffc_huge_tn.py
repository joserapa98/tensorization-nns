...
config_dir = os.path.join(cwd, 'results', '0_train_nns', model_name, '0.5')
...
class TN_Linear1(tk.models.MPO):
    ...
    def __init__(self, model, bond_dim):
        ...
        weight = weight.reshape(1, 5, 5, 5, 2,
...
class TN_Linear2(tk.models.MPO):
    ...
    def __init__(self, model, bond_dim):
        ...
        weight = weight.reshape(3, 5, 5, 2,
                                5, 5, 5, 2).permute(permuted_dims(4))
        self.weight = weight
    ...
    def set_data_nodes(self):
        self.data_node = tk.Node(shape=(1, 5, 5, 5, 2),
...
class TN_Linear3(tk.models.MPO):
    ...
    def __init__(self, model, bond_dim):
        ...
        weight = weight.reshape(2, 5, 5, 1,
                                3, 5, 5, 2).permute(permuted_dims(4))
        self.weight = weight
    ...
    def set_data_nodes(self):
        self.data_node = tk.Node(shape=(1, 3, 5, 5, 2),
                                 axes_names=(('batch', *(['feature'] * 4))),
                                 name='data',
                                 network=self,
                                 data=True)
...
class Model(nn.Module):
    ...
    def __init__(self, bond_dim):
        ...
        self.layers[3].trace(torch.zeros(1, 250))
        self.layers[6].trace(torch.zeros(1, 150))
        self.layers[9].trace(torch.zeros(1, 50))
